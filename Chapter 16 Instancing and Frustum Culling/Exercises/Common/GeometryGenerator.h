...
public:
	...
	struct Vertex
	{
		...
		size_t textureIndex; // For chapter 15 ex3
	};
	...
	///<summary>
	/// Creates 5 adjacent line up boxes in a single MeshData, the middle box is the center, gap as distance between them (for Chapter 15 Exercise) 
	///</summary>
	MeshData CreateFiveBoxes(float width, float height, float depth, float distance);
