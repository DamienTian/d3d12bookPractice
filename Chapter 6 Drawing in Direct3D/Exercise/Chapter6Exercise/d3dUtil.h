...
struct MeshGeometry
{
    ...
    // Chapter 6 Ex 2: break VertexBufferCPU in to pos and color (use two input slots)
    ...
    // Chapter 6 Ex 2: break VertexBufferGPU in to pos and color (use two input slots)
    ...
    // Chapter 6 Ex 2: break VertexBufferUploader in to pos and color (use two input slots)
    ...
    // Chapter 6 Ex 2: break VertexByteStride, VertexBufferByteSize in to pos and color (use two input slots)
    UINT VertexPosByteStride = 0, VertexColorByteStride = 0;
    UINT VertexPosBufferByteSize = 0, VertexColorBufferByteSize = 0;
    ...
    // Chapter 6 Ex 2: break VertexBufferView() into pos and color (use two input slots)
