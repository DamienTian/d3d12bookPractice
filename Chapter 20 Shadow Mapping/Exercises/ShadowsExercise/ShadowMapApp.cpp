...
void ShadowMapApp::Update(const GameTimer& gt)
{
	...
	// NOTE: commented out to observe the shadow map from a static light position.
...
{
	CD3DX12_DESCRIPTOR_RANGE texTable0; // gCubeMap, gShadowMap in the shader.
	texTable0.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 2, 0, 0);

	CD3DX12_DESCRIPTOR_RANGE texTable1; // gTextureMaps in the shader.
