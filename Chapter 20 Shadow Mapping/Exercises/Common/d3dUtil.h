...
struct SubmeshGeometry
{
	...
	DirectX::BoundingSphere BoundsSphere; // For Chapter 16 & 17 Exercise 1
};
...
struct Material
{
	...
	// Index into SRV heap for displacement texture. (Introduced for Chapter 19 practice)
