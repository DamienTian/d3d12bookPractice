...
Answer for Exercise 2: 
	Drawing water first exclude the opaque objects from blending, which occlude the opaque objects
	(see repo "Exercise2Explainations" for more details)
*/

// EX3
//	foggedColor = 0.25*litColor + 0.75*fogColor when dist(p,e) = 160
//	foggedColor = 0.5*litColor + 0.5*fogColor when dist(p,e) = 110
//	foggedColor = 0.75*litColor + 0.25*fogColor when dist(p,e) = 60
//	foggedColor = 0.9*litColor + 0.1*fogColor when dist(p,e) = 30
...
void BlendApp::BuildPSOs()
{
	...
	transparencyBlendDesc.BlendOpAlpha = D3D12_BLEND_OP_SUBTRACT;
