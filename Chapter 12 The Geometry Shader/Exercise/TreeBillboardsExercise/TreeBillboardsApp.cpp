...
void TreeBillboardsApp::BuildRootSignature()
{
	...
	//	note: corresponding resource index in shader
	slotRootParameter[0].InitAsDescriptorTable(1, &texTable, D3D12_SHADER_VISIBILITY_PIXEL);	//t0
    slotRootParameter[1].InitAsConstantBufferView(0);	// b0
    slotRootParameter[2].InitAsConstantBufferView(1);	// b1
    slotRootParameter[3].InitAsConstantBufferView(2);	// b2
